...
title: "About"
---
All the thoughts shared on this site are my own and do not reflect the thinking or policies of anyone else.


<div style="border: 1px solid #d0d0d0; border-radius: 8px; padding: 28px 32px; max-width: 460px; margin: 2.5em 0; box-shadow: 0 2px 12px rgba(0,0,0,0.09); background: #ffffff; font-family: Georgia, 'Times New Roman', serif;">
  <div style="font-size: 1.55em; font-weight: 700; letter-spacing: 0.04em; color: #1a1a1a; line-height: 1.2;">James P. Burke</div>
  ...
  <div style="margin-top: 16px; font-size: 1.25em; line-height: 1;">
    ...
    <a href="https://bsky.app/profile/jamespburke.com/" title="Bluesky" style="margin-right: 14px; color: #0085ff; text-decoration:none;"><i class="fa-brands fa-bluesky"></i></a>
    <a href="https://www.linkedin.com/in/jpburke/" title="LinkedIn" style="margin-right: 14px; color: #0077b5; text-decoration:none;"><i class="fab fa-fw fa-linkedin"></i></a>
    <a href="https://instagram.com/drjpburke/" title="Instagram" style="margin-right: 14px; color: #c13584; text-decoration:none;"><i class="fab fa-fw fa-instagram"></i></a>
    <a href="https://t.me/JPBurke" title="Telegram" style="color: #26a5e4; text-decoration:none;"><i class="fab fa-fw fa-telegram"></i></a>
  </div>
</div>
...
[See the full list of my verified social accounts, and how to verify my identity](/../identity/){: .btn .btn--primary}
