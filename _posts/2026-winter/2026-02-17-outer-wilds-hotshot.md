...
{% include figure popup=true image_path="https://ik.imagekit.io/scurryday/postimg/necessary_interstellar.png" alt="A space station form the movie Interstellar is on the right and a much smaller ship is far to the left in this image. In the background is the surface of an enormous planet." caption="A scene from the film Interstellar, directed by Christopher Nolan" %}
